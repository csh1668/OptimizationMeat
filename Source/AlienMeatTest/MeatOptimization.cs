...
namespace AlienMeatTest
{
    ...
    2) Moyo:
        Solution: Add "Meat_Alien_Moyo" to Whitelist.
    ...
    public static class MeatOptimization
    {
        ...
        public static int OptimizeMeat()
        {
            ...
            foreach (var thingDef in Defs)
            {
                ...
                string useMeatFrom = thingDef.race.useMeatFrom?.defName;
                if (useMeatFrom != null && (useMeatFrom == "Human" || useMeatFrom == "Cow" || useMeatFrom == "Megaspider" ||
                        useMeatFrom == "Steel"))
                    continue;
                ...
                /*
                 * This may useless, since almost all insectoids from vanilla or mods use meat from megaspider.
                 * But we need to investigate more about it.
